        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden mb-6">
          ...
          <div class="p-6">
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                <h3 class="text-sm font-medium text-gray-700 mb-2">Physics Simulation</h3>
                <p class="text-xs text-gray-600">
                  This 3D simulation uses Rapier.js physics engine to create realistic fish-like motion with both active and passive joints.
                </p>
              </div>
            </div>
          </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden">
          ...
          <div class="p-6">
            <ul class="space-y-2 text-sm text-gray-600">
              ...
              <li class="flex items-start">
                <span class="inline-block w-1.5 h-1.5 rounded-full bg-gray-800 mt-1.5 mr-3 flex-shrink-0"></span>
                <span>Physics constraints maintain the structural integrity of the fish body</span>
              </li>
              <li class="flex items-start">
                <span class="inline-block w-1.5 h-1.5 rounded-full bg-gray-800 mt-1.5 mr-3 flex-shrink-0"></span>
                <span>This simulation will be integrated with AprilTag tracking data in future updates</span>
              </li>
            </ul>
          </div>
        </div>
